...
export const breakpointPresets: BreakpointConfig[] = [
  ...
  },
  {
    ...
    description: 'Container width 1280-1680px, 12 columns fixed, content adapts to container width',
    breakpoints: { lg: 1200, md: 996, sm: 768 },
    cols: { lg: 12, md: 10, sm: 6 },
    containerConfig: {
      minWidth: 1280,
...
export const getBreakpointPreset = (id: string): BreakpointConfig => {
  return breakpointPresets.find(preset => preset.id === id) || breakpointPresets[0];
};