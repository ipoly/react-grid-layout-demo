import type { CommandDropdownMenuItemProps } from '@/untitled_ui/application/command-menus/base-components/command-menu-item';
import { CommandMenu } from '@/untitled_ui/application/command-menus/command-menu';
import { EmptyState } from '@/untitled_ui/application/empty-state/empty-state';
    ...
    <>
      ...
      <CommandMenu
        ...
        onSelectionChange={(key) =>
          console.log('You clicked item: ', key.toString())
        }
        emptyState={
