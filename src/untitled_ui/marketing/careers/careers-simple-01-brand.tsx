import type { BadgeColors } from '@/untitled_ui/base/badges/badge-types';

import { Clock, MarkerPin02 } from '@untitledui/icons';

type JobCardNakedProps = {
  title: string;
  description: string;
  href: string;
  location: string;
...
const JobCardNaked = (props: JobCardNakedProps) => {
  return (
    ...
    >
      <h3 className="text-md font-semibold text-primary_on-brand">
        {props.title}
      </h3>
      ...
      <div className="mt-5 flex gap-4">
        <div className="flex items-center gap-1.5">
          ...
          <span className="text-sm font-medium text-tertiary_on-brand">
            {props.location}
          </span>
        </div>
        <div className="flex items-center gap-1.5">
