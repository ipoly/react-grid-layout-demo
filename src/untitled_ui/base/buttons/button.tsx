...
export const styles = sortCx({
  ...
  colors: {
    primary: {
      root: [
        'bg-brand text-white shadow-xs-skeumorphic ring-1 ring-transparent ring-inset hover:bg-brand/90 data-loading:bg-brand/90',
    ...
    secondary: {
      root: [
        'bg-white text-secondary shadow-xs-skeumorphic ring-1 ring-gray-300 ring-inset hover:bg-gray-50 hover:text-secondary_hover data-loading:bg-gray-50',
        // Disabled styles
    ...
    tertiary: {
      root: [
        'text-tertiary hover:bg-gray-50 hover:text-tertiary_hover data-loading:bg-gray-50',
        // Icon styles
        '*:data-icon:text-fg-quaternary hover:*:data-icon:text-fg-quaternary_hover',
      ].join(' '),
    },
