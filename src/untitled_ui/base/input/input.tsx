...
import { Tooltip, TooltipTrigger } from '@/untitled_ui/base/tooltip/tooltip';
  ...
  return (
    <AriaGroup
      ...
      className={({ isFocusWithin, isDisabled, isInvalid }) =>
        cx(
          'relative flex w-full flex-row place-content-center place-items-center rounded-lg bg-white shadow-xs ring-1 ring-gray-300 transition-shadow duration-100 ease-linear ring-inset',
